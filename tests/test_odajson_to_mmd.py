...
class TestJSON2MMD(unittest.TestCase):
    ...
    def test_main_with_frost(self, mock_from_frost, mock_from_file):
        # odajson_to_mmd.main(input_data='FROST', outdir='toto', oda_default=pathlib.Path(
        # "/home/elodief/Work/my_repos/py-mmd-tools_github/templates/oda_default.yml"),
        # oda_mmd_template=pathlib.Path('/home/elodief/Work/my_repos/py-mmd-tools_github/templates/oda_to_mmd_template.xml'), validate=False, mmd_schema=None)
        odajson_to_mmd.main(input_data='FROST', outdir="", oda_default='templates/oda_default.yml',
                            oda_mmd_template='templates/oda_to_mmd_template.xml', validate=False, mmd_schema=None)
        # odajson_to_mmd.main(input_data='FROST', outdir="", oda_default="", oda_mmd_template="", validate=False,
        #                    mmd_schema=None)
    ...
    @mock.patch('py_mmd_tools.odajson_to_mmd.process_all')
    def test_main_with_frost(self, mock_from_frost, mock_from_file):
        odajson_to_mmd.main(input_data=pathlib.Path('/home/elodief/Work/Data/mmd/input/example_oda.json'), outdir="",
                            oda_default='templates/oda_default.yml',
                            oda_mmd_template='templates/oda_to_mmd_template.xml', validate=False, mmd_schema="")
