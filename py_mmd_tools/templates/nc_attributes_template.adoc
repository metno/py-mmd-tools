...
|{{ subelem }} | {{ elem['mmd_field'] }} | {{ elem['comment'] }}
        {% endfor %}
    {% else %}
|{{ elem['attribute'] }} | {{ elem['mmd_field'] }} | {{ elem['comment'] }}
{% endif %}
{% endfor %}
|=======================================================================
...
|{{ subelem }} | {{ elem['default'] }} | {{ elem['mmd_field'] }} | {{ elem['comment'] }}
        {% endfor %}
    {% else %}
|{{ elem['attribute'] }} | {{ elem['default'] }} | {{ elem['mmd_field'] }} | {{ elem['comment'] }}
{% endif %}
{% endfor %}
|=======================================================================
