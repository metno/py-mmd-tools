...
The following elements are ACDD extensions needed to fully support **MMD and data management interoperability**. Required elements must be provided for successful MMD generation; recommended elements improve discoverability. Please refer to the documentation of https://htmlpreview.github.io/?https://github.com/metno/mmd/blob/master/doc/mmd-specification.html[MMD] for more details:
[cols="1,1,3"]
|=======================================================================
